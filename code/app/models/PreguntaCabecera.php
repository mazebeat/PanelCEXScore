...
class PreguntaCabecera extends \Eloquent
{
	...
	public static function generateDefaultQuestions(Encuesta $survey)
	{
		...
		$subquestion1 = static::create(['descripcion_1'     => '¿Por qué califica con esa nota? (opcional)',
		...
		$subquestion2 = static::create(['descripcion_1'     => '¿Por qué califica con esa nota? (opcional)',
		...
		$question3 = static::create(['descripcion_1' => ' Pregunta de lo Grato de la interacción', 'numero_pregunta' => 3, 'id_tipo_respuesta' => 1, 'id_momento' => 3]);
		$question3 = $survey->preguntas()->save($question3);

		$subquestion3 = static::create(['descripcion_1'     => '¿Por qué califica con esa nota? (opcional)',
		...
		$question4 = static::create(['descripcion_1'     => '¿Recomendaría nuestra empresa a sus amigos/conocidos?',
		                             'numero_pregunta'   => 4,
		                             'id_tipo_respuesta' => 6,
		                             'id_estado'         => 1,
		                             'id_momento'        => 4]);
